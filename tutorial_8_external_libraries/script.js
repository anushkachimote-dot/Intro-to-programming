...
const chartData = Object.values(cuisineCounts);
    ...
    const canvas = document.querySelector('#rating-chart');
        ...
        if (!canvas) {
            console.error('ERROR: Canvas element #rating-chart not found in HTML!');
            alert('Canvas not found. Check your HTML file.');
            return;
        }
        
        console.log('Canvas found:', canvas);
        
        // CRITICAL: Get the 2D context RIGHT AFTER getting the canvas
